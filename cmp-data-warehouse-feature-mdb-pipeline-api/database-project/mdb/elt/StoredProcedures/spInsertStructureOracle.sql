CREATE Procedure [elt].[spInsertStructureOracle]
(
						...
						BEGIN
							...
							INSERT INTO [elt].[MetadataStructure]
							        ...
							        SELECT	@SystemCode,
											...
											@lTable AS 'Table',
							                [COLUMN_NAME],
											[elt].[fnConvertDataTypeOracle]([data_type],'oracle',numeric_precision,numeric_scale, [CHARACTER_MAXIMUM_LENGTH]) AS Data_type,
